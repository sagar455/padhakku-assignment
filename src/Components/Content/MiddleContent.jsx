...
const MiddleContent = ({containerRef}) => {
  ...
  return (
    <div className="middle-container">
      <div className="section" ref={containerRef}>
        ...
        <h3 className="section-heading" id="section1">
        ...
        <iframe
         ...
         className="video"
          ...
          allowfullscreen
        ></iframe>
        <div className="sub-section" id="section2">
        ...
        <div className="sub-section" id="section3">
          <h3 className="sub-section-heading">
        ...
        <div className="sub-section" id="section4">
          <h3 className="sub-section-heading">
        ...
        <div className="sub-section" id="section5">
          <h3 className="sub-section-heading">
            Add your contact information
          </h3>
          <img src={SubSection} alt="img" />
        ...
        <div className="sub-section" id="section6">
          <h3 className="sub-section-heading">
            Add your contact information
          </h3>
          <img src={SubSection} alt="img" />
